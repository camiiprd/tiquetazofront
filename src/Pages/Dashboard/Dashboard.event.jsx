...
const Event = () => {
  ...
  const handleCreateEvent = async (e) => {
    ...
    if (newEvent.tickets < 0 || newEvent.description.length > 80 || eventDate < today) {
      alert('Asegúrate de que los boletos no sean negativos, la descripción no exceda 80 caracteres y la fecha sea hoy o futura.');
      return;
    }
